...
void		build_res(t_pbuffer *buf, char *res, char flags[128], \
int len);
...
//Functions from file : ft_strncat.c
...
char		*strncpy_until(char *dest, t_cchar *src, t_cint limiter, \
t_csizet n);

//Functions from file : allocation.c
void		*ft_calloc(size_t nmemb, size_t size);

void		*ft_reallocf(void *memzone, t_csizet old_size, \
size_t new_size);

void		*ft_realloc(void *memzone, t_csizet old_size, \
t_csizet new_size);
